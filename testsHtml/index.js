...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Driver__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Driver */ "./src/Drivers/Driver.js");
...
var LocalStorage = /*#__PURE__*/function (_Driver) {
  ...
  return LocalStorage;
}(_Driver__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
var Model = /*#__PURE__*/function () {
  ...
  _createClass(Model, [{
    ...
    value: function hasMany(model, foreignKey, localKey) {
      return new _Relationships_HasMany__WEBPACK_IMPORTED_MODULE_2__["default"](model, this.constructor).setForeignKey(foreignKey).setLocalKey(localKey);
    }
  }, {
    key: "belongsTo",
    value: function belongsTo(model, foreignKey, ownerKey) {
      return new _Relationships_BelongsTo__WEBPACK_IMPORTED_MODULE_3__["default"](model, this.constructor).setForeignKey(foreignKey).setOwnerKey(ownerKey);
    }
  }, {
    ...
    value: function belongsToRelationships() {
      return this.getRelationshipsByInstanceType(_Relationships_BelongsTo__WEBPACK_IMPORTED_MODULE_3__["default"]);
    }
  }, {
    ...
    value: function count() {
      return new _Query__WEBPACK_IMPORTED_MODULE_0__["default"](this).count();
    }
  }, {
    key: "create",
    ...
    value: function find() {
      ...
      return new _Query__WEBPACK_IMPORTED_MODULE_0__["default"](this).find(id);
    }
  }, {
    key: "findOrFail",
    value: function findOrFail() {
      var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      return new _Query__WEBPACK_IMPORTED_MODULE_0__["default"](this).findOrFail(id);
    }
  }, {
    key: "getQuery",
    value: function getQuery() {
      return new _Query__WEBPACK_IMPORTED_MODULE_0__["default"](this);
    }
  }, {
    key: "primaryKey",
    ...
    value: function table() {
      return pluralize__WEBPACK_IMPORTED_MODULE_1___default()(this.identifier()).toLowerCase();
    }
  }, {
    key: "timestamps",
  ...
  _createClass(Query, [{
    ...
    value: function saveItem(id, data) {
      ...
      if (this.model.timestamps()) {
        if (!data.createdAt) data.createdAt = moment__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DD HH:mm:ss');
        data.updatedAt = moment__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DD HH:mm:ss');
      }
...
/* harmony import */ var _Relationship__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Relationship */ "./src/Relationships/Relationship.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var BelongsTo = /*#__PURE__*/function (_Relationship) {
...
var HasMany = /*#__PURE__*/function (_Relationship) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Relationship; });
/* harmony import */ var _Query__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Query */ "./src/Query.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

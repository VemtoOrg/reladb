...
var Database = __webpack_require__(/*! ./src/Database */ "./src/Database.js");

var _require = __webpack_require__(/*! ./tests/models/Post */ "./tests/models/Post.js"),
    Post = _require["default"];

var _require2 = __webpack_require__(/*! ./tests/models/User */ "./tests/models/User.js"),
    User = _require2["default"];

var LocalStorage = __webpack_require__(/*! ./src/Drivers/LocalStorage */ "./src/Drivers/LocalStorage.js");
...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Command, [{
    ...
    value: function executeParsedCommand() {
      if (this.command === 'clear') return window.RelaDB.driver.clear();
      var parsed = this.parseCommand();
    ...
    value: function parseCommand() {
      var validCommands = ['set', 'remove'],
          validPrepositions = ['on', 'from'];
      var sections = this.command.split(' ');
...
var Command = __webpack_require__(/*! ./Command */ "./src/Command.js");
...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Database, [{
    ...
    key: "cacheItemRelationships",
    value: function cacheItemRelationships(item) {
      var _this = this;
      ...
      item.hasManyRelationships().forEach(function (relationship) {
        ...
        relationshipItems.forEach(function (relatedItem) {
          _this.addItemToTableCache(relatedItem);

          _this.cacheItemRelationships(relatedItem);
        });
      });
    }
  }, {
...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Driver, [{
    ...
    value: function setFromCache(key, data) {
      window.RelaDB.dispatchCommand("set ".concat(key, " on ").concat(this.table), data);
    ...
    value: function removeFromCache(key) {
      window.RelaDB.dispatchCommand("remove ".concat(key, " from ").concat(this.table));
...
var LocalStorage = /*#__PURE__*/function (_Driver) {
  _inherits(LocalStorage, _Driver);
...
var Query = __webpack_require__(/*! ./Query */ "./src/Query.js");

var pluralize = __webpack_require__(/*! pluralize */ "./node_modules/pluralize/pluralize.js");

var HasOne = __webpack_require__(/*! ./Relationships/HasOne */ "./src/Relationships/HasOne.js");

var HasMany = __webpack_require__(/*! ./Relationships/HasMany */ "./src/Relationships/HasMany.js");

var BelongsTo = __webpack_require__(/*! ./Relationships/BelongsTo */ "./src/Relationships/BelongsTo.js");
...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Model, [{
    ...
    key: "fillFromData",
    value: function fillFromData() {
      var _this = this;

      var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var disablePrimaryKeyFill = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      var keys = Object.keys(data);

      if (disablePrimaryKeyFill) {
        keys = keys.filter(function (key) {
          return key != _this.constructor.primaryKey();
        });
      }
    ...
    value: function update() {
      ...
      var wasUpdated = new Query(this.constructor).update(this.id, this);
    ...
    value: function hasOne(model, foreignKey, localKey) {
      return new HasOne(model, this.constructor).setForeignKey(foreignKey).setLocalKey(localKey);
    }
  }, {
    key: "hasMany",
    value: function hasMany(model, foreignKey, localKey) {
      return new HasMany(model, this.constructor).setForeignKey(foreignKey).setLocalKey(localKey);
    }
  }, {
    key: "belongsTo",
    value: function belongsTo(model, foreignKey, ownerKey) {
      return new BelongsTo(model, this.constructor).setForeignKey(foreignKey).setOwnerKey(ownerKey);
    }
  }, {
    key: "hasRelationshipNamed",
    value: function hasRelationshipNamed(name) {
       ...
       */
      var reserved = ['constructor', 'apply', 'bind', 'call', 'toString', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'toLocaleString', 'valueOf', '__defineGetter__', '__defineSetter__', '__lookupGetter__', '__lookupSetter__'];
    ...
    key: "executeRelationship",
    value: function executeRelationship(name) {
      return this.getRelationship(name).execute(this);
    }
  }, {
    key: "hasBelongsToRelationships",
    value: function hasBelongsToRelationships() {
      return this.belongsToRelationships().length > 0;
    }
  }, {
    key: "belongsToRelationships",
    value: function belongsToRelationships() {
      return this.getRelationshipsByInstanceType(BelongsTo);
    }
  }, {
    key: "hasManyRelationships",
    value: function hasManyRelationships() {
    ...
    value: function create() {
      ...
      var item = new Query(this).create(data);
...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Query, [{
    ...
    value: function get() {
      ...
      filteredIndex.forEach(function (id) {
        var item = null;

        if (item = _this.getItem(id)) {
          data.push(new _this.model(item));
        }
      });
    ...
    value: function find() {
      ...
      this.log("Getting item ".concat(id, " from ").concat(this.model.table()));
      ...
      try {
        ...
        this.log("Item ".concat(id, " not found"));
        return null;
      }
    }
  }, {
    ...
    value: function findOrFail() {
      ...
      throw new Error("Item with identifier ".concat(id, " not found on table ").concat(this.model.table()));
    }
  }, {
    key: "update",
    ...
    value: function setFilteredIndex(filteredIndex) {
      this.filteredIndex = filteredIndex;
      return this;
    }
  }, {
    key: "getFilteredIndex",
    value: function getFilteredIndex() {
      var tableData = this.getTableData();
    ...
    key: "clearFilteredIndex",
    value: function clearFilteredIndex() {
      this.filteredIndex = null;
      return this;
    }
  }, {
    ...
    value: function getItem(id) {
      var itemKey = this.tableItemKey(id),
    ...
    key: "saveItem",
    value: function saveItem(id, data) {
      var itemKey = this.tableItemKey(id);
    ...
    key: "checkItemData",
    value: function checkItemData(item, id) {
      if (!item) {
        throw new Error("Item with identifier ".concat(id, " not found on table ").concat(this.table()));
      }
    ...
    key: "getItemHasManyIndex",
    value: function getItemHasManyIndex(item, relationship) {
    ...
    key: "updateItemIndex",
    value: function updateItemIndex(item, newIndexData) {
      if (!item.id) return null;
      var tableData = this.getTableData();
    ...
    key: "tableKey",
    value: function tableKey() {
      return this.model.table();
    }
  }, {
    key: "tableItemKey",
    value: function tableItemKey(id) {
      return "item_".concat(id);
    }
  }, {
    key: "tableStructure",
    ...
    value: function compare(field) {
      ...
      return function (a, b) {
        ...
        var itemA = typeof a[field] === 'number' ? a[field] : a[field].toString().toUpperCase();
        var itemB = typeof b[field] === 'number' ? b[field] : b[field].toString().toUpperCase();
        var comparison = 0;
...
/***/ "./src/Relationships/BelongsTo.js":
/*!****************************************!*\
  !*** ./src/Relationships/BelongsTo.js ***!
  \****************************************/
/*! no static exports found */
...
var Relationship = __webpack_require__(/*! ./Relationship */ "./src/Relationships/Relationship.js");

module.exports = /*#__PURE__*/function (_Relationship) {
  _inherits(BelongsTo, _Relationship);
  ...
  _createClass(BelongsTo, [{
    ...
    key: "setOwnerKey",
    value: function setOwnerKey(ownerKey) {
      if (!ownerKey) {
    ...
    value: function signature() {
      ...
      return "".concat(this.localModel.identifier(), "->").concat(type, "(").concat(this.model.identifier(), "):").concat(this.foreignKey, ",").concat(this.ownerKey);
    }
  }]);
...
module.exports = /*#__PURE__*/function (_Relationship) {
  _inherits(HasMany, _Relationship);
  ...
  _createClass(HasMany, [{
    ...
    value: function setForeignKey(foreignKey) {
      if (!foreignKey) {
        foreignKey = "".concat(this.localModel.identifier().toLowerCase(), "Id");
      }
    ...
    key: "setLocalKey",
    value: function setLocalKey(localKey) {
      if (!localKey) {
    ...
    key: "signature",
    value: function signature() {
      return "".concat(this.localModel.identifier(), "->HasMany(").concat(this.model.identifier(), "):").concat(this.foreignKey, ",").concat(this.localKey);
    }
  }]);
...
var HasMany = __webpack_require__(/*! ./HasMany */ "./src/Relationships/HasMany.js");

module.exports = /*#__PURE__*/function (_HasMany) {
...
module.exports = /*#__PURE__*/function () {
  function Relationship(model, localModel) {
...
/* harmony import */ var _Post__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Post */ "./tests/models/Post.js");
/* harmony import */ var _src_Model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../src/Model */ "./src/Model.js");
/* harmony import */ var _src_Model__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_src_Model__WEBPACK_IMPORTED_MODULE_2__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Comment = /*#__PURE__*/function (_Model) {
  ...
  _createClass(Comment, [{
    ...
    value: function relationships() {
      ...
      return {
        post: function post() {
          return _this.belongsTo(_Post__WEBPACK_IMPORTED_MODULE_1__["default"]);
        },
        author: function author() {
          return _this.belongsTo(_User__WEBPACK_IMPORTED_MODULE_0__["default"], 'authorId');
        }
      };
    }
  }], [{
  ...
  return Comment;
}(_src_Model__WEBPACK_IMPORTED_MODULE_2___default.a);
...
/* harmony import */ var _src_Model__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_src_Model__WEBPACK_IMPORTED_MODULE_1__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Document = /*#__PURE__*/function (_Model) {
  ...
  return Document;
}(_src_Model__WEBPACK_IMPORTED_MODULE_1___default.a);
...
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./User */ "./tests/models/User.js");
/* harmony import */ var _Comment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Comment */ "./tests/models/Comment.js");
/* harmony import */ var _src_Model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../src/Model */ "./src/Model.js");
/* harmony import */ var _src_Model__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_src_Model__WEBPACK_IMPORTED_MODULE_2__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/* harmony import */ var _src_Model__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_src_Model__WEBPACK_IMPORTED_MODULE_4__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var User = /*#__PURE__*/function (_Model) {
  ...
  return User;
}(_src_Model__WEBPACK_IMPORTED_MODULE_4___default.a);
...
module.exports = __webpack_require__(/*! /home/kingofcode/code/packages/reladb/index.js */"./index.js");

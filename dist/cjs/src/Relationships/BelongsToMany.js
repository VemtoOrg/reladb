...
class BelongsToMany extends Relationship_js_1.default {
    relationshipType() {
    ...
    getPivotItems() {
        ...
        if (!itemIndex)
            return [];
        let indexKey = `${this.pivotModel.table()}.${this.foreignPivotKey}`, hasManyIndex = itemIndex.hasMany[indexKey] || [];
